// har ek word ko har ek non (+) cell par horizontally and vertically downwards par place kar ke dekhna hai , agar milta to bohot bhadiya nahi to backtrack.
#include <cmath>
#include <cstdio>
#include <vector>
#include <iostream>
...
void fill(char a[][10], string w[], int n, int used, int take n[10])
{
    if (flag == true)
        return;
    if (used == n && noempty(a))
